...
def get_spatial_phase(phase, source_point, reference_point, k_vec, k_ref, num):
    """
    ...
    if idx < num:
        ...
        # tmp -= (k_ref[0] * reference_point[0] +
        #        k_ref[1] * reference_point[1] +
        #        k_ref[2] * reference_point[2])
